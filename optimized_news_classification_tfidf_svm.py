# ============================================================
# ============================================================
# News Category Classification: Baselines and Optimized Model
# ============================================================
# ============================================================
...
# ============================================================
# Proposed model: TF-IDF + Optimized Linear SVM
# ============================================================
my_model = Pipeline([
...
print("\n========================")
print("Proposed model: TF-IDF + Linear SVM")
print("========================")
...
print(f"Proposed model: {my_accs.mean():.5f}")
print("=====================================")