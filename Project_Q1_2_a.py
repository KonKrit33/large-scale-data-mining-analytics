...
# 0) Load train.xlsx
# -------------------------
df = pd.read_excel(r"C:\Users\Konstantinos Krit\Desktop\MSc\Α' Εξάμηνο\High Scale Analytics\Project 2025-2026\bigdata2025classification\train.xlsx")  # columns: Id, Title, Content, Label
