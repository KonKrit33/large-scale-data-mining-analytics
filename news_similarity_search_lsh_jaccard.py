...
# ============================================================
# 4) LSH with explicit threshold
#    datasketch chooses (b,r) internally based on num_perm and threshold
# ============================================================
...
def build_lsh(X_text, num_perm=32, tau=0.9):
    """
    1) Try the standard MinHashLSH threshold-based configuration.
